...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      <div
        className={`${sizeClasses[size]} relative rounded-xl bg-gradient-to-br from-[#004481] via-[#005baa] to-[#0c5fae] p-1.5 flex items-center justify-center shadow-sm ring-1 ring-black/10 shrink-0 group-hover:shadow transition-all`}
      >
        <svg
          viewBox="0 0 36 36"
          fill="none"
